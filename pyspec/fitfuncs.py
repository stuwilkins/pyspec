...
try:
	...
	import warnings
	warnings.warn("You are not using wxPython. Graphical selection of fit parameters is not avaliable")

try:
	import pylab as _pylab
except ImportError:
	import warnings
	warnings.warn("You are not using pylab. Graphical selection of fit parameters is not avaliable")
