 ...
 Outputs:
   ...
   .perror
      ...
      *If* you can assume that the true reduced chi-squared value is unity --
      ...
      ## LIMITED parameters ?
      limited = Numeric.array(self.parinfo(parinfo, 'limited', default=Numeric.array([0,0])))
      limits = Numeric.array(self.parinfo(parinfo, 'limits', default=Numeric.array([0.,0.])))
